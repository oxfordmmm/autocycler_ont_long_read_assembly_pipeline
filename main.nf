...
include {CHECKM2_CONSENSUS} from './modules/assemble.nf'
...
include {MOB_SUITE} from './modules/assemble.nf'
include {SUMMARISE_RAWQC} from './modules/assemble.nf'
include {SUMMARISE_CONTAMINATED} from './modules/assemble.nf'
include {SUMMARISE_INPUT_ASSEMBLY_QC} from './modules/assemble.nf'
include {SUMMARISE_CONSENSUS_ASSEMBLY_CHECKM2} from './modules/assemble.nf'
include {SUMMARISE_CONSENSUS_ASSEMBLY_SEQKIT} from './modules/assemble.nf'
include {SUMMARISE_MLST} from './modules/assemble.nf'
include {SUMMARISE_KRAKEN2} from './modules/assemble.nf'
include {SUMMARISE_AMRFINDER} from './modules/assemble.nf'
include {SUMMARISE_BAKTA} from './modules/assemble.nf'
include {SUMMARISE_MOBSUITE} from './modules/assemble.nf'
...
workflow {
    ...
    contam_free_reads_ch = GENOME_SIZE_AND_CONTAMINATION.out.data
        .filter { sample, source, reads, raven, raven_assembly, checkm2_report, contamination, genome_size -> contamination.text.trim().toFloat() < 20.0}
   ...
   //CHECKM2_INPUT_ASSEMBLIES.out.tsv.view()

   AUTOCYCLER_COMPRESS(flattened_assemblies)
   //AUTOCYCLER_COMPRESS.out.all.view()
   ...
   //FILTER out failed Autocycler consensus assemblies where >100 unitigs 
    ...
    // 8. MOB-suite 
    all_mobsuite_ch = MOB_SUITE.out.all.collect()
    SUMMARISE_MOBSUITE(all_mobsuite_ch)
